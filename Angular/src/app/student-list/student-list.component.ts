...
export class StudentListComponent implements OnInit {
 ...
 constructor(private studentservice:StudentService) { }
  ...
  studentupdateform=new FormGroup({
    ...
    student_gpa:new FormControl(),
    student_contact:new FormControl()
  });
  ...
  get StudentGpa(){
    return this.studentupdateform.get('student_gpa');
  }

  get StudentContact(){
    return this.studentupdateform.get('student_contact');
  }
